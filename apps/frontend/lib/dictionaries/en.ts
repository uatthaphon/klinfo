export default {
  ...
  onboarding: {
    ...
    inviteTeamDescription:
      "Add your clinic members. You can add more later depending on your subscription.",
    singleMemberNotice: "Your account will be the first member. Upgrade your plan to invite more.",
