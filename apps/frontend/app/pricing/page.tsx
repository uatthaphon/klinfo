...
const plans = [
  {
    name: (t: TFunction) => t('pricing.plan.free'),
    monthlyPrice: 0,
    info: (t: TFunction) => t('pricing.info.free'),
    tooltip: (t: TFunction) => t('pricing.tooltips.free'),
    features: [
      {
        icon: ListCheck,
        text: (t: TFunction) => t('pricing.features.queueManagement'),
        category: 'Core Features',
        available: true,
      },
      {
        icon: Users,
        text: (t: TFunction) => t('pricing.features.patientList'),
        category: 'Core Features',
        available: true,
      },
      {
        icon: MapPin,
        text: (t: TFunction) => t('pricing.features.visitTracking'),
        category: 'Core Features',
        available: true,
      },
      {
        icon: ShoppingCart,
        text: (t: TFunction) => t('pricing.features.orderFinalization'),
        category: 'Core Features',
        available: false,
      },
      {
        icon: ShoppingCart,
        text: (t: TFunction) => t('pricing.features.billing'),
        category: 'Core Features',
        available: false,
      },
      {
        icon: FileText,
        text: (t: TFunction) => t('pricing.features.mcGenerator'),
        category: 'Core Features',
        available: false,
      },
      {
        icon: Bell,
        text: (t: TFunction) => t('pricing.features.followUp'),
        category: 'Core Features',
        available: false,
      },
      {
        icon: LayoutTemplate,
        text: (t: TFunction) => t('pricing.features.mcTemplates'),
        category: 'Core Features',
        available: false,
      },
      {
        icon: LayoutTemplate,
        text: (t: TFunction) => t('pricing.features.consultationTemplates'),
        category: 'Core Features',
        available: false,
      },
      {
        icon: LayoutTemplate,
        text: (t: TFunction) => t('pricing.features.prescriptionTemplates'),
        category: 'Core Features',
        available: false,
      },
      { icon: User, text: (t: TFunction) => t('pricing.features.oneUser'), category: 'Team', available: true },
      {
        icon: ShieldCheck,
        text: (t: TFunction) => t('pricing.features.secureLogin'),
        category: 'Security',
        available: true,
      },
      {
        icon: UserCog,
        text: (t: TFunction) => t('pricing.features.roleAccess'),
        category: 'Security',
        available: false,
      },
      {
        icon: BarChart3,
        text: (t: TFunction) => t('pricing.features.insights'),
        category: 'Reports',
        available: false,
      },
      { icon: FileText, text: (t: TFunction) => t('pricing.features.export'), category: 'Reports', available: false },
      {
        icon: Building,
        text: (t: TFunction) => t('pricing.features.multiBranch'),
        category: 'Business',
        available: false,
      },
    ],
  ...
  {
    name: (t: TFunction) => t('pricing.plan.standard'),
    monthlyPrice: 490,
    info: (t: TFunction) => t('pricing.info.standard'),
    tooltip: (t: TFunction) => t('pricing.tooltips.standard'),
    features: [
      {
        icon: ListCheck,
        text: (t: TFunction) => t('pricing.features.queueManagement'),
      ...
      {
        icon: LayoutTemplate,
        text: (t: TFunction) => t('pricing.features.mcTemplates') + ' (Limit 2)',
        category: 'Core Features',
        available: true,
        limit: true,
      },
      {
        icon: LayoutTemplate,
        text: (t: TFunction) => t('pricing.features.consultationTemplates') + ' (Limit 2)',
        category: 'Core Features',
        available: true,
        limit: true,
      },
      {
        icon: LayoutTemplate,
        text: (t: TFunction) => t('pricing.features.prescriptionTemplates') + ' (Limit 2)',
        category: 'Core Features',
        available: true,
        limit: true,
      },
      { icon: Users, text: (t: TFunction) => t('pricing.features.staff3'), category: 'Team', available: true },
      {
        icon: ShieldCheck,
        text: (t: TFunction) => t('pricing.features.secureLogin'),
        category: 'Security',
      ...
      {
        icon: BarChart3,
        text: (t: TFunction) => t('pricing.features.insights') + ' (Basic)',
        category: 'Reports',
        available: true,
        limit: true,
      },
  ...
  {
    name: (t: TFunction) => t('pricing.plan.pro'),
    monthlyPrice: 990,
    info: (t: TFunction) => t('pricing.info.pro'),
    tooltip: (t: TFunction) => t('pricing.tooltips.pro'),
    features: [
      {
        icon: ListCheck,
        text: (t: TFunction) => t('pricing.features.queueManagement'),
      ...
      { icon: User2, text: (t: TFunction) => t('pricing.features.unlimitedStaff'), category: 'Team', available: true },
      {
        icon: ShieldCheck,
        text: (t: TFunction) => t('pricing.features.secureLogin'),
        category: 'Security',
      ...
      { icon: BarChart3, text: (t: TFunction) => t('pricing.features.insights'), category: 'Reports', available: true },
      { icon: FileText, text: (t: TFunction) => t('pricing.features.export'), category: 'Reports', available: true },
      {
        icon: Building,
        text: (t: TFunction) => t('pricing.features.multiBranch'),
        category: 'Business',
  ...
  {
    name: (t: TFunction) => t('pricing.plan.premium'),
    monthlyPrice: 1490,
    info: (t: TFunction) => t('pricing.info.premium'),
    tooltip: (t: TFunction) => t('pricing.tooltips.premium'),
    features: [
      {
        icon: ListCheck,
        text: (t: TFunction) => t('pricing.features.queueManagement'),
      ...
      {
        icon: Building,
        text: (t: TFunction) => t('pricing.features.multiBranchLimit'),
        category: 'Business',
        available: true,
      },
    ],
              ...
              <div className={flexWrapGroupClass}>
                <div className={avatarGroupClass}>
                  <Avatar className={avatarClass}>
                    <AvatarImage className={avatarImageClass} src="https://github.com/shadcn.png" alt="@shadcn" />
                    <AvatarFallback className={avatarFallbackClass}>CN</AvatarFallback>
                  </Avatar>
                  <Avatar className={avatarClass}>
                    <AvatarImage className={avatarImageClass} src="https://github.com/leerob.png" alt="@leerob" />
            ...
            <TabsList className={billingTabsListClass}>
              <TabsTrigger
                ...
                className={`${tabsTriggerClass} ${
                  billingCycle === 'monthly' ? tabsTriggerActiveClass : tabsTriggerInactiveClass
                }`}>
                {t('pricing.monthly')}
              </TabsTrigger>
              <TabsTrigger
                value="yearly"
                className={`relative ${tabsTriggerClass} ${
                  billingCycle === 'yearly' ? tabsTriggerActiveClass : tabsTriggerInactiveClass
                }`}>
                {t('pricing.yearly')}
                ...
                <p className={cardInfoClass}>
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <span className={tooltipTriggerClass}>{t('pricing.infoLabel', { info: plan.info })}</span>
                    </TooltipTrigger>
                          ...
                          {categoryFeatures.map((feature, featureIndex) => (
                            <li key={featureIndex} className={featureItemClass}>
                              ...
                              <span className={featureTextClass}>
                                ...
                                {feature.available === false && <span className={iconUnavailableClass}>✗</span>}{' '}
                                {feature.text}
                              </span>
                            </li>
                          ))}
