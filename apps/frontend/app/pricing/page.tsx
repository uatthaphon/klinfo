...
const plans = [
  {
    ...
    features: [
      {
        icon: ListCheck,
        text: (t: any) => t('pricing.features.queueManagement'),
      ...
      {
        icon: MapPin,
        text: (t: any) => t('pricing.features.visitTracking'),
        category: 'Core Features',
        available: true,
      },
      {
        icon: ShoppingCart,
        text: (t: any) => t('pricing.features.orderFinalization'),
        category: 'Core Features',
        available: false,
      },
      {
        icon: ShoppingCart,
        text: (t: any) => t('pricing.features.billing'),
        category: 'Core Features',
        available: false,
      },
      {
        icon: FileText,
        text: (t: any) => t('pricing.features.mcGenerator'),
        category: 'Core Features',
        available: false,
      },
      ...
      {
        icon: LayoutTemplate,
        text: (t: any) => t('pricing.features.mcTemplates'),
        category: 'Core Features',
        available: false,
      },
      {
        icon: LayoutTemplate,
        text: (t: any) => t('pricing.features.consultationTemplates'),
        category: 'Core Features',
        available: false,
      },
      {
        icon: LayoutTemplate,
        text: (t: any) => t('pricing.features.prescriptionTemplates'),
        category: 'Core Features',
        available: false,
      },
  ...
  },
  {
    ...
    features: [
      ...
      {
        icon: LayoutTemplate,
        text: (t: any) => t('pricing.features.mcTemplates') + ' (Limit 2)',
        category: 'Core Features',
        available: true,
        limit: true,
      },
      {
        icon: LayoutTemplate,
        text: (t: any) => t('pricing.features.consultationTemplates') + ' (Limit 2)',
        category: 'Core Features',
        available: true,
        limit: true,
      },
      {
        icon: LayoutTemplate,
        text: (t: any) => t('pricing.features.prescriptionTemplates') + ' (Limit 2)',
        category: 'Core Features',
        available: true,
        limit: true,
      },
      ...
      {
        icon: BarChart3,
        text: (t: any) => t('pricing.features.insights') + ' (Basic)',
        category: 'Reports',
        available: true,
        limit: true,
      },
  ...
  },
  {
    ...
    features: [
      ...
      {
        icon: Building,
        text: (t: any) => t('pricing.features.multiBranchLimit'),
        category: 'Business',
        available: true,
      },
    ],
